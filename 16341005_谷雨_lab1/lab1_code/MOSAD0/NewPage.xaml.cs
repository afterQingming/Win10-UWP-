...
namespace MOSAD0
{
    ...
    public sealed partial class NewPage : Page
    {
        ...
        {
            this.ViewModel.AddTodoItem(title.Text, details.Text, date.Date,img.Width,img.Source);
        }
        ...
        private void clearContent()
        {
            ...
            img.Source = new BitmapImage(new Uri("ms-appx:///Assets/timg.jpg"));
            //BitmapImage temp= new BitmapImage(new Uri("ms-appx:///Assets/timg.jpg"));
